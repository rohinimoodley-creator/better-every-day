...
export const EXPLORE_SECTIONS = [
  {
    ...
    items: [
      ...
      { id: 'w_rest', label: 'Rest (Sleep & Recovery)', targetTab: 'WELLNESS', params: { category: 'rest' }, icon: Moon },
      { id: 'w_skincare', label: 'Skincare (Morning & Evening Routines)', targetTab: 'WELLNESS', params: { category: 'skincare' }, icon: Sparkles },
